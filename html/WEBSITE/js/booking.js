...
waves.addEventListener('mousemove', (e) => {
   ...
   waves.style.boxShadow = `inset ${-insetX}px ${-insetY}px 2px var(--dark-color),
...
waves.addEventListener('mouseleave', () => {
   waves.style.boxShadow = `inset 0 -2px 2px var(--dark-color),
